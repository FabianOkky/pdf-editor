...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="min-h-screen bg-zinc-50 antialiased dark:bg-zinc-950">
        <flux:sidebar sticky collapsible="mobile" class="border-e border-zinc-200 bg-white dark:border-zinc-800 dark:bg-zinc-900">
            ...
            {{-- A quiet reminder of the product's one promise, where it reassures rather than sells. --}}
            <div class="mx-2 mb-2 rounded-xl border border-zinc-200 bg-zinc-50 p-3 dark:border-zinc-800 dark:bg-zinc-950">
                <div class="flex items-center gap-2 text-xs font-medium text-zinc-700 dark:text-zinc-300">
                    ...
                    {{ __('Originals preserved') }}
                </div>
                <p class="mt-1 text-xs leading-relaxed text-zinc-500 dark:text-zinc-500">
                    {{ __('Every edit is saved as a new version. Your upload is never overwritten.') }}
                </p>
            </div>
